...
![DHCP Relay](screenshot3_dhcprelay.PNG)
...
![Example of firewall rules for client VLANs](screenshot4_clientfirewallrules.PNG)
...
![Guest VLAN Rules](screenshot5_guestvlanrules.PNG)
...
![DHCP Scopes on DC02](screenshot6_dhcp1.PNG)

DHCP configuration on `DC01`:
![DHCP Scopes on DC01](screenshot7_dhcp2.PNG)

Example of scope configuration:
![Example of scope configuration](screenshot8_dhcp3.PNG)

Example of scope options:
![Example of scope options](screenshot10_dhcpoptions.PNG)

Example of client IP configuration:
![Client DHCP information](screenshot9_dhcp4.PNG)
...
Forest Info:
![Forest Info](screenshot11_forestinfo.PNG)

DNS:
![Cooklab DNS zone](screenshot12_dns.PNG)

![Welcome to the cooklab.local domain](screenshot13_domainjoin.PNG)
...
![Organizational Unit Structure](screenshot14_organizationalunits.PNG)
![Organizational Units in PowerShell](screenshot15_ouspowershell.PNG)
...
![DFS Root](screenshot16_dfs1.PNG)
...
![DFS Replication](screenshot18_dfsreplication.PNG)
...
![File Screen Template for Non-Technical Workers](screenshot16_filescreening1.PNG)

File screens:
![File Screens](screenshot17_filescreening2.PNG)
...
Drive maps:
![Drive Maps](screenshot19_drivemaps.PNG)

Example of targeting based on group membership:
![Drive Map Targeting](screenshot20_itemleveltargeting.PNG)

User who belongs to the Finance and Administration department group:
![Example of user's mapped drives](screenshot21_drivemapuser.PNG)
